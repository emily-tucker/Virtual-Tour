        ...
        return this.each(function (options) {
            ...
            function setUpDrilldown() {
                ...
                if (defaults.linkType == 'link') {
                    menuHeight = itemHeight * (2 * maxItems + getIndex)
                } else {
                    menuHeight = itemHeight * maxItems
                }
                $($dcDrilldownObj).css({height: menuHeight, width: totalWidth});
        ...
        function actionDrillDown(element, wrapper, obj) {
            ...
            if (defaults.linkType == 'breadcrumb') {
                ...
                if (getNewBreadcrumb == defaults.defaultText) {
                    $('ul', $header).append('<li><a href="#" class="first">' + defaults.resetText + '</a></li>' + '<br>')
                } else {
